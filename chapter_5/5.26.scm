...
;;  tail-recursive property of the evaluator (5.4.2). Start the
;;  evaluator and define the iterative factorial procedure from 1.2.1:
...
;; independent of n . What is that depth?  Determine from your data a
;; formula in terms of n for the total number of push operations used
;; in evaluating n ! for any n ≥ 1 . Note that the number of
;; operations used is a linear function of n and is thus determined by
;; two constants.
