...
;; labels that immediately precede that instruction in the controller
;; sequence. Be careful to do this in a way that does not interfere
;; with instruction counting (Exercise 5.15). You will have to make
