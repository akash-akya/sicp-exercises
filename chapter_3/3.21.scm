...
;; Lisp interpreter and proceeds to try them out: (define q1
;; (make-queue))
...
;; Ben has misunderstood what is happening. “It’s not that the items
;; are going into the queue twice,” she explains. “It’s just that the
...
;; what Eva Lu is talking about. In particular, show why Ben’s
;; examples produce the printed results that they do. Define a
;; procedure print-queue that takes a queue as input and prints the
