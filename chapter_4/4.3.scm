...
;; differentiation procedure of Exercise 2.73. (You may use the car of
;; a compound expression as the type of the expression, as is
...
;; test
(define (test)
  (test-equal (my-eval '(+ 7 8 9) the-global-environment) 24)
  (test-equal (my-eval '(begin (define a 10) (+ 10 a)) the-global-environment) 20))
