...
;; Exercise 4.12: The procedures define-variable!, set-variable-value!
;; and lookup-variable-value can be expressed in terms of more
;; abstract procedures for traversing the environment
...
(define (test-primitive)
  (define-variable! 'a 10 the-global-environment)
  (test-equal (lookup-variable-value 'a the-global-environment)
    10)
  (define-variable! 'b 20 the-global-environment)
  (test-equal (lookup-variable-value 'b the-global-environment)
    20)
  (define-variable! 'b 30 the-global-environment)
  (test-equal (lookup-variable-value 'b the-global-environment)
    30)
  (set-variable-value! 'a 50 the-global-environment)
  (test-equal (lookup-variable-value 'a the-global-environment)
    50))
...
(define (test)
  ...
  (test-equal (test-eval '(+ (* 2 3) 1)) 7)
  (test-equal (test-eval '(if (> 2 3) "true" "false")) "false"))
