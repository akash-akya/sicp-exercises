...
(define (my-eval exp env)
  (cond ((self-evaluating? exp)
        ...
        ((quoted? exp)
         ;; (display "Quoted: ") (display (my-eval (text-of-quotation exp) env)) (newline)
         ;; (display (text-of-quotation exp)) (newline)
...
(define (test)
  ...
  ;; test `create-list'
  (test-equal (create-list '(1 2 3)) '(cons (quote 1) (cons (quote 2) (cons (quote 3) (quote ())))))
  (test-equal (test-eval '(cdr (cons 1 2))) 2)
  (test-equal (test-eval '(car (quote (a b c)))) 'a))
